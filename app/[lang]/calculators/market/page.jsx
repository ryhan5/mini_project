...
const MarketCalculatorClient = dynamic(
  () => import('./MarketCalculatorClient'),
  { 
    ssr: false,
    loading: () => (
...
export default function MarketCalculatorPage({ params: { lang } }) {
  // Validate language
  ...
  return <MarketCalculatorClient lang={lang} />;
}